...
using TF.Core.Projects.Disgaea.Files;

namespace TF.Core.Projects.Disgaea
{
    public class DisgaeaProject : Project
    {
        public override string CompatibleFilesFilter => "Archivos de Texto de Disgaea|talk.dat";
        ...
        protected DisgaeaProject(Repository repository)
        {
        ...
        public static DisgaeaProject GetProject(string path)
        {
            ...
            var result = new DisgaeaProject(repository) {Path = path};
            return result;
        }
