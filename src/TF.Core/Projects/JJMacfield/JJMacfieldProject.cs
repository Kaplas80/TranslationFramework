...
using TF.Core.Projects.JJMacfield.Files;

namespace TF.Core.Projects.JJMacfield
{
    public class JJMacfieldProject : Project
    {
        public override string CompatibleFilesFilter => "Archivos de Texto de JJMacfield|*.txt";
        ...
        protected JJMacfieldProject(Repository repository)
        {
            _repository = repository;
        }

        public static JJMacfieldProject GetProject(string path)
        {
            ...
            var result = new JJMacfieldProject(repository) {Path = path};
            return result;
        }
