...
using TF.Core.Projects.Infliction.Files;

namespace TF.Core.Projects.Infliction
{
    public class InflictionProject : Project
    {
        public override string CompatibleFilesFilter => "Archivos de Texto de Infliction|*.uexp";
        ...
        protected InflictionProject(Repository repository)
        {
            _repository = repository;
        }

        public static InflictionProject GetProject(string path)
        {
            ...
            var result = new InflictionProject(repository) {Path = path};
            return result;
        }
